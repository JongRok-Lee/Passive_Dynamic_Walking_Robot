function [v_H,v_1s,v_1t,v_2s,v_2t] = velocity1(n0,x,v_H,v_1s,v_1t,v_2s,v_2t)
...
if rem(n0,2) == 1
    ...
    v_2c0 = v_Hp + l_t*[cos(x(1:end-1,3)).*x(1:end-1,4) sin(x(1:end-1,3)).*x(1:end-1,4)];
    v_2s0 = v_2c0 + b_s*[cos(x(1:end-1,5)).*x(1:end-1,6) sin(x(1:end-1,5)).*x(1:end-1,6)];
    ...
    v_1c0 = v_Hp + l_t*[cos(x(1:end-1,3)).*x(1:end-1,4) sin(x(1:end-1,3)).*x(1:end-1,4)];
    v_1s0 = v_1c0 + b_s*[cos(x(1:end-1,5)).*x(1:end-1,6) sin(x(1:end-1,5)).*x(1:end-1,6)];
