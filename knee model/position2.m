function [xi0, p_H,p_1f,p_2f,p_1c, p_2c, p_1t, p_2t,p_1s,p_2s] = position2(n0,x,t,xi0,p_H,p_1f,p_2f,p_1c, p_2c, p_1t, p_2t,p_1s,p_2s)
...
if rem(n0,2) == 1
    ...
    % leg2의 발
    p_02f = p_Hpb + L*[sin(x(:,3)) -cos(x(:,3))];
    
    % leg_1s의 위치
    p_1sb = p_01f + a_s*[-sin(x(:,1)) cos(x(:,1))];
    % leg_1t의 위치
    p_1tb = p_01f + (l_s+a_t)*[-sin(x(:,1)) cos(x(:,1))];
    % leg_2t의 위치
    p_2tb = p_Hpb + b_t*[sin(x(:,3)) -cos(x(:,3))];
    % leg_2s의 위치
    p_2sb = p_Hpb + (l_t+b_s)*[sin(x(:,3)) -cos(x(:,3))];
    ...
    % leg1의 발
    p_01f = p_Hpb + L*[sin(x(:,3)) -cos(x(:,3))];
    
    % leg_2s의 위치
    p_2sb = p_02f + a_s*[-sin(x(:,1)) cos(x(:,1))];
    % leg_2t의 위치
    p_2tb = p_02f + (l_s+a_t)*[-sin(x(:,1)) cos(x(:,1))];
    % leg_1t의 위치
    p_1tb = p_Hpb + b_t*[sin(x(:,3)) -cos(x(:,3))];
    % leg_1s의 위치
    p_1sb = p_Hpb + (l_t+b_s)*[sin(x(:,3)) -cos(x(:,3))];
